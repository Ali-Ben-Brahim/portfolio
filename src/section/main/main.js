...
export default function mainpage() {
  return (
    ...
    <div>
    <h2>Hello, I'm Ali <br/><span>Web  Mobile developer</span></h2>
    <h3>Développeur diplômé en Business Computing</h3>
    ...
    <div className="social-icons">
        ...
        <a href="benbrahimali23@gmail.com" target="_blank" rel="noreferre"><GrMail/></a>
    </div>
</div>
</section>
  )
